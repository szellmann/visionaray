...
int main()
{
    ...
    vector<3, simd::float4> n = get_normal(normals, hr, basic_triangle<3, float, unsigned>{}, per_face_binding{});
    ...
    vector<3, simd::float8> n = get_normal(normals, hr, basic_triangle<3, float, unsigned>{}, per_face_binding{});
#endif
    ...
    auto n = get_normal(normals, hr, basic_triangle<3, float, unsigned>{}, per_face_binding{});
    ...
    vector<3, float>* normals;
    hit_record<basic_ray<simd::float4>, primitive<unsigned>> hr;
    vector<3, simd::float4> n = get_shading_normal(normals, hr, basic_triangle<3, float, unsigned>{}, per_vertex_binding{});
    ...
    vector<3, float>* normals;
    hit_record<basic_ray<simd::float8>, primitive<unsigned>> hr;
    vector<3, simd::float8> n = get_shading_normal(normals, hr, basic_triangle<3, float, unsigned>{}, per_vertex_binding{});
#endif
    ...
    vector<3, float>* normals;
    hit_record<basic_ray<simd::int4>, primitive<unsigned>> hr;
    auto n = get_shading_normal(normals, hr, basic_triangle<3, float, unsigned>{}, per_vertex_binding{});
