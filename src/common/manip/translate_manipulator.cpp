...
static vec2i get_projected_center(camera const& cam, mat4 const& model_matrix)
{
    vec3 win;
    vec3 obj(0.0f);
...
static recti get_projected_center_rect(camera const& cam, mat4 const& model_matrix)
{
