...
VSNRAY_FORCE_INLINE mask16::basic_mask(
    ...
    : value(
        (0x1    &  x1 <<  0) | (0x2    &  x2 <<  1) | (0x4    &  x3 <<  2) | (0x8    &  x4 <<  3) |
        (0x10   &  x5 <<  4) | (0x20   &  x6 <<  5) | (0x40   &  x7 <<  6) | (0x80   &  x8 <<  7) |
        (0x100  &  x9 <<  8) | (0x200  & x10 <<  9) | (0x400  & x11 << 10) | (0x800  & x12 << 11) |
        (0x1000 & x13 << 12) | (0x2000 & x14 << 13) | (0x4000 & x15 << 14) | (0x8000 & x16 << 15)
        )
{
}
...
VSNRAY_FORCE_INLINE mask16::basic_mask(bool const v[16])
    : value(
        (0x1    & v[ 0] <<  0) | (0x2    & v[ 1] <<  1) | (0x4    & v[ 2] <<  2) | (0x8    & v[ 3] <<  3) |
        (0x10   & v[ 4] <<  4) | (0x20   & v[ 5] <<  5) | (0x40   & v[ 6] <<  6) | (0x80   & v[ 7] <<  7) |
        (0x100  & v[ 8] <<  8) | (0x200  & v[ 9] <<  9) | (0x400  & v[10] << 10) | (0x800  & v[11] << 11) |
        (0x1000 & v[12] << 12) | (0x2000 & v[13] << 13) | (0x4000 & v[14] << 14) | (0x8000 & v[15] << 15)
        )
{
}
