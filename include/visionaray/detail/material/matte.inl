...
VSNRAY_FUNC
inline spectrum<T> matte<T>::cd(SR const& sr, V const& n, V const& wo, V const& wi) const
{
    VSNRAY_UNUSED(sr);
...
VSNRAY_FUNC
inline spectrum<T> matte<T>::cd(shade_record<L, C, S> const& sr, V const& n, V const& wo, V const& wi) const
{
